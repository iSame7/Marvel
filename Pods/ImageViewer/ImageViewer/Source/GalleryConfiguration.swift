...
func defaultGalleryConfiguration() -> GalleryConfiguration {
    ...
    button.setImage(UIImage(named: "icn-nav-close-white"), forState: UIControlState.Normal)
    button.setImage(UIImage(named: "icn-nav-close-white"), forState: UIControlState.Highlighted)
